...
print 'WHITE PLAYER RANGE X: (%.2f, %.2f)' % (SORTED_NORTH_RANGE_X[0], SORTED_NORTH_RANGE_X[-1])
print 'WHITE PLAYER RANGE Y: (%.2f, %.2f)' % (SORTED_NORTH_RANGE_Y[0], SORTED_NORTH_RANGE_Y[-1])
print 'BLACK PLAYER RANGE X: (%.2f, %.2f)' % (SORTED_SOUTH_RANGE_X[0], SORTED_SOUTH_RANGE_X[-1])
print 'BLACK PLAYER RANGE Y: (%.2f, %.2f)' % (SORTED_SOUTH_RANGE_Y[0], SORTED_SOUTH_RANGE_Y[-1])
